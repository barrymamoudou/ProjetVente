                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Modification Produit</a></li>

                        </ol>
                    </div>
                    <h4 class="page-title">Modification Produits</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-pane" id="settings">
                            <form id="myForm" method="post" action="{{ route('product.update') }}" enctype="multipart/form-data">
                                ...
                                <h5 class="mb-4 text-uppercase"><i class="mdi mdi-account-circle me-1"></i>Modification Produits
                                </h5>

            ...
            <div class="col-12">
                <div class="page-title-box">
                    <div class="page-title-right">
                        ...
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Client Facture</a></li>
                        </ol>
                    </div>
                    <h4 class="page-title">Client Facture</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                        ...
                        <div class="row mt-3">
                            <div class="col-sm-6">
                                ...
                                <address>
                                    ...
                                    <br>
                                    <abbr title="Phone">Shop Nom:</abbr> {{ $customer->shopname }}<br>
                                    <abbr title="Phone">Telephone:</abbr> {{ $customer->phone }}<br>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="float-end">
                                    ...
                                    <p><b>Valeur de taxe (10%):</b> <span class="float-end"> &nbsp;&nbsp;&nbsp;
                                            ${{ Cart::tax() }}</span></p>
                                    <h3>${{ Cart::total() }} FGN</h3>
                                </div>
            ...
            <div class="modal-body"> 
                <div class="text-center mt-2 mb-4 ">
                        <div class="auth-logo">
                            ...
                            <h3>Total Montant  ${{ Cart::total() }}</h3>
                        </div>
                </div>

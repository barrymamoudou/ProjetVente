                ...
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <div class="bg-primary">
                            ...
                            <p style="font-size:18px; color:#fff"> Valeur Taxe : {{ Cart::tax() }} </p>
                        ...
                        @csrf
                            ...
                            <div class="form-group mb-3">
                                ...
                                <a href="{{ route('add.customer') }}"
                                    class="btn btn-primary rounded-pill waves-effect waves-light mb-2">Ajouter
                                    Client </a>
...
<script type="text/javascript">
    $(document).ready(function (){
        $('#myForm').validate({
            ...
            messages :{
                customer_id: {
                    required : 'Please Selectionner Client',
                }, 

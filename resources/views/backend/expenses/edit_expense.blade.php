        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4>Modfication Des Depenses</h4>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="tab-pane" id="settings">
                            <form action="{{ route('expense.update') }}" enctype="multipart/form-data"  method="post">
                                @csrf
                                ...
                                <div class="text-end">
                                    <button type="submit" class="btn btn-success waves-effect waves-light mt-2"><i class="mdi mdi-content-save"></i> Enregistrement</button>
                                </div>

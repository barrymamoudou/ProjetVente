    ...
    <div id="sidebar-menu">
        ...
        <ul id="side-menu">
            ...
            <li>
                <a href="#sidebarEcommerce" data-bs-toggle="collapse">
                    ...
                    <span> Gestion Employees </span>
                    <span class="menu-arrow"></span>
                </a>
                <div class="collapse" id="sidebarEcommerce">
                    <ul class="nav-second-level">
                        <li>
                            <a href="{{route('all.employee')}}">Liste Employees</a>
                        </li>
                        <li>
                            <a href="{{route('add.employee')}}">Ajouter Employee</a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            <div class="collapse" id="sidebarEmail">
                <ul class="nav-second-level">
                    <li>
                        <a href="{{ route('all.supplier') }}">Liste Fournisseurs</a>
                    </li>
                    <li>
                        <a href="{{ route('add.supplier') }}">Ajoute Fournisseurs</a>
                    </li>
        ...
        <li>
            ...
            <div class="collapse" id="product">
                <ul class="nav-second-level">
                    <li>
                        <a href="{{ route('all.product') }}">Liste  Product </a>
                    </li>

                     <li>
                        <a href="{{ route('add.product') }}">Ajouter Product </a>
                    </li>
                    <li>
